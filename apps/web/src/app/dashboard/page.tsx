...
const quickActions = [
  ...
  },
  {
    ...
    icon: Icons.cloud,
    href: '/dashboard/tenants/connect',
    color: 'bg-green-500',
  },
  {
    title: 'Create Backup',
                  ...
                  >
                    <div
                      className={cn(
                        ...
                        activity.status === 'success' && 'bg-green-100 text-green-600 dark:bg-green-900/30',
                        activity.status === 'in_progress' && 'bg-blue-100 text-blue-600 dark:bg-blue-900/30',
                        activity.status === 'warning' && 'bg-yellow-100 text-yellow-600 dark:bg-yellow-900/30',
                        activity.status === 'error' && 'bg-red-100 text-red-600 dark:bg-red-900/30',
                      )}
                    >
